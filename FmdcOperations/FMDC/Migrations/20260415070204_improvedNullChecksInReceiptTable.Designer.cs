...
namespace FMDC.Migrations
{
    ...
    [Migration("20260415070204_improvedNullChecksInReceiptTable")]
    partial class improvedNullChecksInReceiptTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.ReceiptDetails", b =>
                {
                    ...
                    b.ToTable("ReceiptDetails", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReceiptDetails_ProcedureOrTest", "[ProcedureId] IS NOT NULL OR [TestId] IS NOT NULL");
                        });
                });
